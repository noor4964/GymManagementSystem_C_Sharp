...
namespace Gym_Management_System
{
    public partial class Trainer : Form
    {
        public Trainer()
        {
            ...
            headerPanelTrainer.BackColor = header;

            headerTrainerPanel.BackColor = header;
        ...
        {
            // TODO: This line of code loads data into the 'gym_Management_SystemDataSet8.Employee_Salary' table. You can move, or remove it, as needed.
            this.employee_SalaryTableAdapter1.Fill(this.gym_Management_SystemDataSet8.Employee_Salary);
